        ...
        if (!player.canPlayerEdit(x, y, z, dir, stack)) {
            ...
            if (world.canPlaceEntityOnSide(cropBlock, x, y, z, false, dir, null, stack)) {
                ...
                if (world.setBlock(x, y, z, cropBlock, meta, 3)) {
                    ...
                    world.playSoundEffect((float) x + 0.5F, (float) y + 0.5F, (float) z + 0.5F, cropBlock.stepSound.func_150496_b(), (cropBlock.stepSound.getVolume() + 1.0F) / 2.0F, cropBlock.stepSound.getPitch() * 0.8F);
                    --stack.stackSize;
                }
            }
