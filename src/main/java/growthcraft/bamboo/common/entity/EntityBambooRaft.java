package growthcraft.bamboo.common.entity;
...
public class EntityBambooRaft extends Entity {
    ...
    public void onUpdate() {
        ...
        for (int i = 0; i < b0; ++i) {
            final double d1 = this.boundingBox.minY + (this.boundingBox.maxY - this.boundingBox.minY) * (double) (i) / (double) b0 - 0.125D;
        ...
        if (this.worldObj.isRemote && this.isBoatEmpty) {
            ...
            if (this.riddenByEntity != null && this.riddenByEntity instanceof EntityLivingBase entitylivingbase) {
