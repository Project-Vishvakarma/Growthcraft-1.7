...
public class ShapelessMultiRecipe implements IRecipe {
    ...
    private final ArrayList<IMultiItemStacks> input = new ArrayList<IMultiItemStacks>();
    private final ArrayList<IMultiFluidStacks> fluids = new ArrayList<IMultiFluidStacks>();
